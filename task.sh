...
#   dir3
#       dir4
mkdir -pv task/dir1 task/dir2 task/dir3/dir4
...
# хотел сделать так cd ../ | rm -rf /task но при удалении ты остаешься все равно в директории task, мб дописать cd ../ | rm -rf /task | cd /
cd ../
